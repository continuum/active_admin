    ...
    def has_many(association, options = {}, &block)
      ...
      content = with_new_form_buffer do
        template.content_tag :div, :class => "has_many #{association}" do
          form_buffers.last << template.content_tag(:h3, I18n.t("active_admin.has_many.models.#{association.to_s}").titlecase)
          ...
          js = template.link_to I18n.t('active_admin.has_many_new', :model => I18n.t("active_admin.has_many.models.#{association.to_s}").singularize.titlecase), "#", :onclick => "$(this).before('#{js}'.replace(/NEW_RECORD/g, new Date().getTime())); return false;", :class => "button"
