...
== Custom Layout
  ...
  To add a custom layout yo must use the configuration:

    #  
    config.custom_layout = "application"

  And at layout you must add the css and js files of active_admin
    = stylesheet_link_tag "active_admin.css"
